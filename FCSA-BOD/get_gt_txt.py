...
image_ids = open('/home/tingkai/1workspace/common/data_uod/jpg_and_annotation_difficult_p3/test/ImageSets/Main/test.txt').read().strip().split()
...
for image_id in image_ids:
    with open("./input/ground-truth/"+image_id+".txt", "w") as new_f:
        ...
        root = ET.parse("/home/tingkai/1workspace/common/data_uod/jpg_and_annotation_difficult_p3/test/Annotations/"+image_id+".xml").getroot()
